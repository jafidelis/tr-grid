...
angular.module('trComponents', [])
    .constant('trMaskConstants', {
        DOT: '.',
        COMMA: ',',
        EMPTY: '',
        ZERO: 0,
    ...
    .factory('maskService', function(trMaskConstants) {
        var service = {};
        ...
        service.formatarCampoDecimal = function(element, attrs, align) {
            ...
            return element.
            maskMoney({thousands: trMaskConstants.DOT, decimal: trMaskConstants.COMMA,
                allowZero: true, precision: precision}).
            css('text-align', align);
        };

        service.formatarCampoInteiro = function(element, attrs, align) {
            return element.
            maskMoney({precision: trMaskConstants.ZERO, thousands: trMaskConstants.EMPTY, decimal: trMaskConstants.EMPTY}).
            css('text-align', align);
        };
    ...
    .directive('trDecimal', function(maskService, trMaskConstants) {
        return {
            restrict: 'A',
            require: 'ngModel',
            link: function(scope, element, attrs, ctrl) {
                ...
                ctrl.$parsers.unshift(function(value) {
                    value = value.replace(trMaskConstants.DOT_REGEXP, '');
                    value = value.replace(trMaskConstants.COMMA, trMaskConstants.DOT);
                    return value;
                });
